...
var writeGltf = require('gltf-pipeline/lib/writeGltf');
var addPipelineExtras = require('gltf-pipeline/lib/addPipelineExtras');
...
function convert(objFile, outputPath, options) {
    ...
    return parseObj(objFile, inputPath)
        ...
        .then(function(gltf) {
            ...
            // console.log('addPipelineExtras start');
            // addPipelineExtras(gltf);
            // console.log('addPipelineExtras end');
